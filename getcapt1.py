...
def get_aadh_cap():
    ...
    if real_time > expire_time1 or count1 == 0:
        ...
        res = requests.get("http://superpvc.in/code.php")
        #print(res.text)
        header = "Cookie: "+res.text
        #header = "Cookie: __RequestVerificationToken=tysOL3OVluTVex7aQKmWLhAGhlrg1-0klx3YdekKrqBPgOjHqVq1oZpDkavwsvcfFRmRZ1hjw9jufUtCsNKPN41d-CH8jfw8AsnVK6tpWjo1; ServerAffinity=53ce6a2839080d44a20632f7d508af421d55ec1a84537bf06c26103e24c3507b; runOnce=true; electoralSearchId=pbt5evaxm1yxa1bu2kylgh53; s=; _ga=GA1.2.254212312.1589213368; _gid=GA1.2.569711653.1589213368"
        cmd = f'curl --output "/home/skprxprb/public_html/Captcha2/aadhar/aadharcaptcha'+str(val)+'.jpeg" -H "'+header+'" "'+url+'"'
        #print(cmd)
        os.system(cmd)
        count1 = 1
        expire_time1 = real_time + 10
        img_var1 = "Captcha2/aadhar/aadharcaptcha"+str(val)+".jpeg"
        ...
        #print("/home/skprxprb/public_html/captcha"+str(val)+".jpeg")
        fp = open("/home/skprxprb/public_html/Captcha2/aadhar/aadharcaptcha.text","w+")
        fp.write(text.replace(" ", ""))
        fp.close()
        return text.replace(" ","")
    else:
        img = cv2.imread("/home/skprxprb/public_html/Captcha2/aadhar/aadharcaptcha12345.jpeg")
...
def get_aadh_cap1():
    ...
    if real_time > expire_time11 or count11 == 0:
        ...
        res = requests.get("http://superpvc.in/code1.php")
        #print(res.text)
        header = "Cookie: "+res.text
        #print(header)
        #header = "Cookie: __RequestVerificationToken=tysOL3OVluTVex7aQKmWLhAGhlrg1-0klx3YdekKrqBPgOjHqVq1oZpDkavwsvcfFRmRZ1hjw9jufUtCsNKPN41d-CH8jfw8AsnVK6tpWjo1; ServerAffinity=53ce6a2839080d44a20632f7d508af421d55ec1a84537bf06c26103e24c3507b; runOnce=true; electoralSearchId=pbt5evaxm1yxa1bu2kylgh53; s=; _ga=GA1.2.254212312.1589213368; _gid=GA1.2.569711653.1589213368"
        ...
        text = pytesseract.image_to_string(img)
        #print("/home/skprxprb/public_html/captcha"+str(val)+".jpeg")
        fp = open("/home/skprxprb/public_html/Captcha2/aadhar/aadharcaptcha1.text","w+")
        fp.write(text.replace(" ", ""))
        fp.close()
        return text.replace(" ","")
    else:
        img = cv2.imread("/home/skprxprb/public_html/Captcha2/aadhar/aadharcaptcha123451.jpeg")
...
if __name__ == "__main__":
    ...
    app.run("103.83.81.250",2055, debug=True)
